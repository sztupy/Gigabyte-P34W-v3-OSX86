 ...
 *
 * Disassembly of SSDT-9.aml, Tue Aug 25 22:52:52 2015
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000018EE (6382)
 *     Revision         0x01
 *     Checksum         0x5D
 *     OEM ID           "SgRef"
 *     OEM Table ID     "SgPeg"
 ...
 */
DefinitionBlock ("SSDT-9.aml", "SSDT", 1, "SgRef", "SgPeg", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.EC__.TDRF, MethodObj)    // 1 Arguments
    ...
    External (_SB_.PCI0.PEG0.PEGP.RXCM, MethodObj)    // 1 Arguments
    External (_SB_.PCI0.PEG0.PEGP.TDGC, IntObj)
    External (_SB_.PCI0.PEG0.PEGP.WD13, IntObj)
    External (_SB_.PCI0.PEG0.PEGP.WXCM, MethodObj)    // 2 Arguments
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        ...
        Name (WMSB, Zero)
        Name (DMLW, Zero)
        OperationRegion (NVAD, SystemMemory, 0xF810048B, 0x0100)
        ...
        Method (SGON, 0, Serialized)
        {
            ...
            SDSE (0xC0, One)
            Store (RXCM (0x03), WD13)
            WXCM (0x03, Add (WD13, One, WD13))
            Store (Zero, NVAE)
            Return (One)
        }
        ...
        Method (SGOF, 0, Serialized)
        {
            ...
            SGPO (HLRS, One)
            SGPO (PWEN, Zero)
            Store (RXCM (0x04), WD13)
            WXCM (0x04, Add (WD13, One, WD13))
            SDSE (0xC0, Zero)
            Store (Zero, NVAE)
            Return (Zero)
        }
