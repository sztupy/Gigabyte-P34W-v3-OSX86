 ...
 *
 * Disassembly of SSDT-10.aml, Tue Aug 25 22:52:52 2015
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000018AB (6315)
 *     Revision         0x01
 *     Checksum         0x9C
 *     OEM ID           "OptRef"
 ...
 */
DefinitionBlock ("SSDT-10.aml", "SSDT", 1, "OptRef", "OptTabl", 0x00001000)
{
    ...
    External (_SB_.PCI0.LPCB.EC__.STEC, FieldUnitObj)
    ...
    Scope (\_SB.PCI0.PEG0.PEGP)
    {
        ...
        Method (GC6I, 0, Serialized)
        {
            Store ("<<< GC6I >>>", Debug)
            Store (0x55, DBG8)
            Store (One, \_SB.PCI0.LPCB.EC.STEC)
            \_SB.PCI0.PEG0.PEGP.SPP0 ()
            Store (One, \_SB.PCI0.PEG0.LNKD)
            While (LNotEqual (\_SB.PCI0.PEG0.PEGP.SGPI (0xA2), One))
            {
                Sleep (One)
            }
        }
        ...
        Method (GC6O, 0, Serialized)
        {
            ...
            Store (Zero, \GPEV)
            While (LNotEqual (\_SB.PCI0.PEG0.PEGP.SGPI (0xA2), Zero))
            {
                Sleep (One)
            }
            ...
            Store (Zero, \_SB.PCI0.LPCB.EC.STEC)
        }

        Method (GETS, 0, Serialized)
        {
            If (LEqual (\_SB.PCI0.PEG0.PEGP.SGPI (0xA2), Zero))
            {
