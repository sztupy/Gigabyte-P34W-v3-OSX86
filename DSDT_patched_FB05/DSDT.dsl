 ...
 *
 * Disassembly of DSDT.aml, Thu Dec  3 21:07:17 2015
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000CF38 (53048)
 *     Revision         0x02
 *     Checksum         0x8F
 *     OEM ID           "GBT   "
                    ...
                    Name (BUF0, ResourceTemplate()
{
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xCB2DCE18, 0x10)
                                                                            ...
                                                                            Else
                                                                            {
                                                                                ...
                                                                                Else
                                                                                {
                                                                                    ...
                                                                                    Else
                                                                                    {
                                                                                        If (LEqual (_T_0, 0x71))
                                                                                        {
                                                                                            Store (Zero, ^^LPCB.EC.GFAN)
                                                                                            Store (Arg2, ^^LPCB.EC.FANB)
                                                                                            Return (^^LPCB.EC.FANB)
                                                                                        }
                                                                                        Else
                                                                                        {
                                                                                            ...
                                                                                            Else
                                                                                            {
                                                                                                If (LEqual (_T_0, 0x70))
                                                                                                {
                                                                                                    Store (Zero, ^^LPCB.EC.TFAN)
                                                                                                    Store (One, ^^LPCB.EC.GFAN)
                                                                                                    Store (Arg2, ^^LPCB.EC.FAN1)
                                                                                                    Store (Arg2, ^^LPCB.EC.FAN2)
                                                                                                    Return (^^LPCB.EC.FAN1)
                                                                                                }
                                                                                                Else
                                                                                                {
